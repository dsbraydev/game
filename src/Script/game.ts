    ...
    setTimeout(() => {
      ...
      if (isCorrect) {
        ...
        particleSystem.emitter = new BABYLON.Vector3(
          trophyMesh.position.x,
          trophyMesh.position.y + 3,
          trophyMesh.position.z
        );
        ...
        particleSystem.color2 = new BABYLON.Color4(0.4, 1, 0.4, 1);
        particleSystem.colorDead = new BABYLON.Color4(0.4, 0.4, 1, 0);
        ...
        particleSystem.maxEmitPower = 0.75;
